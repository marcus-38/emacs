...
#+end_src
** Themes
Some packages, such as EF-themes, I download myself into =~/.emacs.d/manual-packages/<package>=. To be able to use
these packages I first add the path to the =load-path= list and then =require= each package.
