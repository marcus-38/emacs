...
:END:
[[https://github.com/rlister/org-present][Org-present]] is meant to be an extremely minimalist presentation tool for Emacs org-mode. Simply layout
your presentation with each slide under a top-level header, start the minor mode with 'org-present, and
page through each slide with left/right keys.
