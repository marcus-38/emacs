...
:END:
I really had a thought of what to put in here but I can't remeber what it was. I keep it as a
reminder to myself I can put stuff in the profiles file for eshell later.
...
:END:
I set a large threshold for garbage collection at start. After the =after-init-hook= I set it
to a lower number. This needs more work.
...
I keep this code because I'm interesting in finding out what makes
M-x not working.
