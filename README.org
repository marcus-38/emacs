...
#+AUTHOR: Marcus
#+REVEAL_ROOT: file:///~/.emacs.d/manual-packages/reveal.js/js/reveal.js
...
- [[#generate-files-and-file-headers][Generate files and file headers]]
  ...
  - [[#aliases][Aliases]]
  - [[#profile][Profile]]
- [[#put-stuff-in-early-inite][Put stuff in early-init.e]]
...
* Put stuff in early-init.e
:PROPERTIES:
:ID:       F46F08A4-309D-47DA-B246-23E70D9B935D
:CUSTOM_ID: put-stuff-in-early-inite
:END:
** Garbage collection
:PROPERTIES:
...
#+RESULTS:
: file:///~/.emacs.d/manual-packages/reveal.js/js/reveal.js
