...
#+begin_src bash :tangle eshell/aliases
  ...
  alias ls exa -al --color-always --group-directories-first $*   # my prefered listing
...
** TOC-ORG
[[https://github.com/snosov1/toc-org][toc-org]] helps you to have an up-to-date table of contents in org files without exporting.
#+begin_src emacs-lisp :tangle init.el
